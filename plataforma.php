...
$id_secao1_cta = $data_header['plataforma_secao1_cta'];
...
$secao1_cta = !empty($secao1_cta[0]) ? $secao1_cta[0] : array();
...
<head>
    ...
    <link href="<?php echo $data_header['d1_favico'];?>" rel="shortcut icon" type="image/x-icon">
</head>
