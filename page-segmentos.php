...
@media only screen and (max-width: 767px) {
    .segmentos-hero {
        background-image:url('<?php echo $segmento['url_img_bg'];?>')!important;
    }
}
        ...
        <div class="mycontainer">
            <div class="home-hero-wrapper left">
                <div class="home-hero-left left _16pad nopad">
                    <h6 class="lightblue type-gradient fixed" data-ix="fade-in-on-load"><span><?php echo $segmento['title'];?></span></h6>
