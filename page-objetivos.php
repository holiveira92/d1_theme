...
<head>
    ...
    ?>
    <title><?php echo $langs[$language_option]['solucoes'] . mb_convert_case($dados['title'], MB_CASE_TITLE, "UTF-8");?> - D1</title>
</head>
<?php
get_header();
?>
    ...
    <div class="mycontainer">
        <div class="modulos-card-wrapper" data-ix="fade-in-on-scroll">
            <div class="section-title">
                <h6 class="h1white"><?php echo $dados['options']['objetivos_secao1_desafios_title'];?></h6>
            </div>
