        ...
        <div class="mycontainer-2">
            ...
            <div class="div-block-5">
                <div class="div-block-6">
                    <!--a href="<?php echo $footer_cta2['link']; ?>" target="<?php echo $footer_cta2['target']; ?>" class="btn-play-outline w-button"><?php echo $footer_cta2['title']; ?></a>-->
                </div>
                ...
                <div class="div-block-6">
                    <!--a href="<?php echo $footer_cta3['link']; ?>" target="<?php echo $footer_cta3['target']; ?>" class="btn-cx-outline w-button"><?php echo $footer_cta3['title']; ?></a>-->
                </div>
            </div>
