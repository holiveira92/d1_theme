        ...
        <div class="mycontainer">
            <div class="home-hero-wrapper">
                <div class="home-hero-left" data-ix="fade-in-on-load">
                    <h1 class="white pad20"><?php echo insert_degrade($data_home['secao1_hero_title'],2);?></h1>
                    <div class="white pad20"><?php echo $data_home['secao1_descricao_primaria'];?></div>
                    <a href="<?php echo $data_home['secao1_conheca_um_minuto'];?>" class="btn-gradient w-button">CONHEÇA EM 1 MINUTO</a>
                </div>
                <div class="home-hero-right">
                    <h3 class="white"><?php echo $data_home['secao1_hero_name'];?></h3>
                    <h6 class="lightblue"><?php echo $data_home['secao1_hero_cargo'];?></h6>
                    <div class="white pad20"><?php echo $data_home['secao1_hero_descricao'];?></div><img src="<?php echo $data_home['secao1_hero_company'];?>" alt="" class="home-hero-logo-partner"></div>
            </div>
        </div>
    </div>
        ...
        <div>
            <div class="mycontainer">
                <div class="section-title-2col">
                    <h6 class="white pad20"><?php echo $data_home['secao1_descricao_secundaria'];?></h6>
    ...
    <div class="section-wrapper-large">
        <div class="mycontainer">
            <div class="section-title" data-ix="fade-in-on-scroll">
                <h6 class="darkgrey pad20"><?php echo $data_home['secao2_empresas_title'];?></h6>
            </div>
    ...
    <div class="section-wrapper">
        <div class="mycontainer">
            <div class="section-title">
                <h6 class="darkgrey pad20"><?php echo $data_home['secao4_section_title_part2'];?></h6>
            </div>
            <div class="case-thumb-content-wrapper" data-ix="fade-in-on-scroll-2">
                ...
                ?>
                    <a href="<?php echo $data_home[$key_link];?>" style='text-decoration:none;'>
                    <div class="desafio-thumb-content">
                        <div class="case-thumb-title">
                            <h3 class="white"><?php echo $data_home[$key_title];?></h3>
    ...
    <div class="section-wrapper-large black-bg-stripe">
        <div class="mycontainer">
            <div class="section-1col-wrapper" data-ix="fade-in-on-scroll-2">
                <h1 class="white pad20"><?php echo $data_home['secao5_section_title'];?></h1>
                <div class="white pad20"><?php echo $data_home['secao5_section_descricao'];?></div>
                    <a href="<?php echo $data_home['secao5_link_calcular'];?>" class="btn-cx w-button">CALCULAR CX</a>
                </div>
        </div>
    </div>
    ...
    <div class="tab-section-wrapper" data-ix="fade-in-on-scroll">
        <div class="mycontainer">
            <div class="tabs-section-title-2col">
                <h6 class="pad20"><?php echo $data_home['secao6_title'];?></h6>
                ...
                <div class="tabs-menu w-tab-menu">
                    ...
                    ?>
                        <a data-w-tab="Tab <?php echo $i;?>" class="home-tab-link w-inline-block w-tab-link <?php echo $title_class;?>">
                            <div><?php echo $data_home[$key_title];?></div>
                        </a>
                    <?php endfor; ?>
                </div>
